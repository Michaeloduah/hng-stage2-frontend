...
const API_SEARCH="https://api.themoviedb.org/3/search/movie?query&api_key=f7d948a1f846fa710b4efe2448ebe23e"
    ...
    <>
      ...
      <div>
        ...
        <div className="container">
          ...
          <h2 className="text-center text-white mt-5">Sorry!! No Movies Found</h2>
        )}
      </div>
    </>
  );
